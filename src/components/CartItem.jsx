        ...
        <div className="card-actions justify-start mt-10 w-full">
          <div className="flex justify-between">
            <button onClick={() => increment(cartProduct)}>
              <PlusCircleIcon className="h-10 text-emerald-400 hover:scale-110 transition-all duration-75 ease-in" />
            </button>
            <p className="mt-2 ml-2 font-semibold">{cartProduct.count}</p>
            <button className="ml-2" onClick={() => decrement(cartProduct)}>
              <MinusCircleIcon className="h-10 text-blue-400 hover:scale-110 transition-all duration-75 ease-in" />
            </button>
          </div>
        </div>
        <div className="card-actions justify-end">
          <button onClick={() => remove(cartProduct)}>
            <TrashIcon className="h-10 text-red-400 hover:scale-110 transition-all duration-75 ease-in" />
          </button>
        </div>
      </div>
    </main>
